...
public partial class FEA_repQuartNotOnOffer : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            int flag = 0;
            string tablename = "TRAI_QuartNotOnOffer";
            ...
            if (flag == 0)
            {
                ...
                mystr = mystr + "<tr><td class=tablecell align=right colspan=2><b>Name of Service Provider : </b></td><td class=tablecell align=left colspan=3><b>" + oper + "</b></td></tr>";
                mystr = mystr + "<tr><td class=tablecell align=right colspan=2><b>Prepaid / Postpaid : </b></td><td class=tablecell align=left colspan=3><b>" + prepost + "</b></td></tr>";
                mystr = mystr + "<tr><td class=tablecell align=right colspan=2><b>Name of Service Area : </b></td><td class=tablecell align=left colspan=3><b>" + circ + "</b></td></tr>";
                mystr = mystr + "<tr><td class=tablecell align=center colspan=5><b>Quarterly Report for Bulk Tariff plans of Corporate Plans for the Quarter ending " + qtr + " " + yr.ToString() + "</b></td></tr>";
                mystr = mystr + "<tr>";
                mystr = mystr + "<td class=tablecell width=10% align=center><b>S. No.</b></td>";
                mystr = mystr + "<td class=tablecell width=50% align=center><b>List of plan(s)</b></td>";
                mystr = mystr + "<td class=tablecell width=20% align=center><b>Number of subscriber (as on last day of quarter)</b></td>";
                mystr = mystr + "<td class=tablecell width=10% align=center><b>Launch date of plan</b></td>";
                mystr = mystr + "<td class=tablecell width=10% align=center><b>Withdrawal date of plan</b></td>";
                mystr = mystr + "</tr>";
                ...
                while (dr.Read())
                {
                    ...
                    mystr = mystr + "<td class=tablecell align=left valign=top>" + dr["plan"].ToString().Trim() + "</td>";
                    mystr = mystr + "<td class=tablecell align=right valign=top>" + dr["subscribers"].ToString().Trim() + "</td>";
                    mystr = mystr + "<td class=tablecell align=center valign=top>" + Convert.ToDateTime(dr["ldate"].ToString().Trim()).ToString("dd-MMM-yyyy") + "</td>";
                    mystr = mystr + "<td class=tablecell align=center valign=top>" + Convert.ToDateTime(dr["wdate"].ToString().Trim()).ToString("dd-MMM-yyyy") + "</td>";
                    mystr = mystr + "</tr>";
                    sno++;
