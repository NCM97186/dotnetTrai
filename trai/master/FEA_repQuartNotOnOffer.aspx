<%@ Page Language="C#" AutoEventWireup="true" EnableViewStateMac="false" ValidateRequest="false"  CodeFile="FEA_repQuartNotOnOffer.aspx.cs" Inherits="FEA_repQuartNotOnOffer" %>
...
<center >
    ...
    <div>
        ...
        <table width="95%" runat="server" cellspacing="1" cellpadding="8" id="Table1">
            <tr>
            <td colspan="2" align="center" class="tablehead">Quarterly Report of tariff plans existing in the billing system but not on offer </td>
            </tr>
            ...
            <tr>
                <td align="left" valign="top" class="tablecell3">Prepaid / Postpaid <font color="red"><b>*</b></font></td>
                <td align="left" valign="top" class="tablecell3"><asp:RadioButtonList ID="RadPrePost" runat="server" RepeatDirection="Horizontal"><asp:ListItem Selected="True" style="margin-right:20px;">Prepaid</asp:ListItem><asp:ListItem>Postpaid</asp:ListItem></asp:RadioButtonList></td>
            </tr>
            <tr>
        ...
        <table runat="server" cellspacing="1" cellpadding="8" width="100%">
            ...
            <tr>
                <td colspan="2" align="center" class="tablecell" id="TdData" runat="server" visible="false"></td>
            </tr>
        </table>
