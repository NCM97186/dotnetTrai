...
public partial class FEA_repQuartPrepaid : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (flag == 0)
            {
                ...
                string mystr = "<font face=arial><b><u>Quarterly Prepaid Tariff Reporting (Annexure - I)</u></b></font><br /><br />";
                ...
                if (plancount > 0)
                {
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center style=width:15px;>Sl No.</td>";
                    mystr = mystr + "<td class=tablecell align=center style=width:45px;>Particulars / Services</td>";
                    mystr = mystr + "<td class=tablecell align=center style=width:35px;>Details</td>";
                    for (int i = 1; i <= plancount; i++)
                    {
                        mystr = mystr + "<td class=tablecell align=center><p style=width:35px;>" + i.ToString() + "</p></td>";
                    }
                    mystr = mystr + "</tr>";
                    ...
                    while (dr.Read())
                    {
                        arrParameters[tmp1, 0] = dr["planname"].ToString().Trim().Replace("~", "&quot;");
                    ...
                    for (int i = 0; i < plancount; i++)
                    {
                        ...
                        while (dr2.Read())
                        {
                            arrParameters[i, 4] = dr2["mrp"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            double freecalls = -1;
                            try
                            {
                                if (dr2["ttype"].ToString().Trim().ToUpper().Contains("FIXED"))
                                {
                                    if (Convert.ToDouble(dr2["fixed_MCU"].ToString().Trim()) > freecalls)
                                    {
                                        freecalls = Convert.ToDouble(dr2["fixed_MCU"].ToString().Trim());
                                    }
                                    if (Convert.ToDouble(dr2["fixed_MCU_999"].ToString().Trim()) > freecalls)
                                    {
                                        freecalls = Convert.ToDouble(dr2["fixed_MCU_999"].ToString().Trim());
                                    }
                                    if (Convert.ToDouble(dr2["fixed_MCU_29999"].ToString().Trim()) > freecalls)
                                    {
                                        freecalls = Convert.ToDouble(dr2["fixed_MCU_29999"].ToString().Trim());
                                    }
                                    if (Convert.ToDouble(dr2["fixed_MCU_99999"].ToString().Trim()) > freecalls)
                                    {
                                        freecalls = Convert.ToDouble(dr2["fixed_MCU_99999"].ToString().Trim());
                                    }
                                    if (Convert.ToDouble(dr2["fixed_MCU_100K"].ToString().Trim()) > freecalls)
                                    {
                                        freecalls = Convert.ToDouble(dr2["fixed_MCU_100K"].ToString().Trim());
                                    }
                                    if (Convert.ToDouble(dr2["fixed_freetalk"].ToString().Trim()) > freecalls)
                                    {
                                        freecalls = Convert.ToDouble(dr2["fixed_freetalk"].ToString().Trim());
                                    }
                                }
                                else
                                {
                                    if (Convert.ToDouble(dr2["add_localstd"].ToString().Trim()) > freecalls)
                                    {
                                        freecalls = Convert.ToDouble(dr2["add_localstd"].ToString().Trim());
                                    }
                                    if (Convert.ToDouble(dr2["add_localstd_on"].ToString().Trim()) > freecalls)
                                    {
                                        freecalls = Convert.ToDouble(dr2["add_localstd_on"].ToString().Trim());
                                    }
                                    if (Convert.ToDouble(dr2["add_localstd_off"].ToString().Trim()) > freecalls)
                                    {
                                        freecalls = Convert.ToDouble(dr2["add_localstd_off"].ToString().Trim());
                                    }
                                    if (Convert.ToDouble(dr2["add_localstd_mob"].ToString().Trim()) > freecalls)
                                    {
                                        freecalls = Convert.ToDouble(dr2["add_localstd_mob"].ToString().Trim());
                                    }
                                    if (Convert.ToDouble(dr2["add_localstd_mob_on"].ToString().Trim()) > freecalls)
                                    {
                                        freecalls = Convert.ToDouble(dr2["add_localstd_mob_on"].ToString().Trim());
                                    }
                                    if (Convert.ToDouble(dr2["add_localstd_mob_off"].ToString().Trim()) > freecalls)
                                    {
                                        freecalls = Convert.ToDouble(dr2["add_localstd_mob_off"].ToString().Trim());
                                    }
                                }
                            }
                            catch (Exception ex) { }
                            arrParameters[i, 5] = freecalls.ToString().Trim().Replace("-1", "");
                            arrParameters[i, 6] = dr2["regprom"].ToString().Trim().ToUpper();
                            arrParameters[i, 7] = dr2["validity"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 8] = dr2["local_all_voicepulse"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 9] = dr2["local_all_voicecharges"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");

                            arrParameters[i, 10] = dr2["local_on_voice_peak"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 11] = dr2["local_off_voice_peak"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 12] = dr2["local_fix_on_voice_peak"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");

                            arrParameters[i, 13] = dr2["std_on_voice_peak"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 14] = dr2["std_off_voice_peak"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 15] = dr2["std_fix_on_voice_peak"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");

                            arrParameters[i, 16] = dr2["isd_mobile"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 17] = dr2["isd_landline"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");

                            arrParameters[i, 18] = dr2["sms_all_local"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 19] = dr2["sms_all_national"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 20] = dr2["sms_int"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");

                            arrParameters[i, 21] = dr2["datacharges_home"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 22] = dr2["datacharges_roam"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 23] = dr2["datacharges_rental"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");

                            arrParameters[i, 24] = dr2["roam_call_voice_out"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 25] = dr2["roam_call_voice_std"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 26] = dr2["roam_call_voice_in"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 27] = (dr2["roam_sms_local"].ToString().Trim() + " / " + dr2["roam_sms_nat"].ToString().Trim() + " / " + dr2["roam_sms_int"].ToString().Trim()).Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");

                            arrParameters[i, 28] = dr2["roam_sms_local"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 29] = dr2["roam_sms_nat"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 30] = "NIL";
                            arrParameters[i, 31] = dr2["roam_sms_int"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");

                            arrParameters[i, 32] = dr2["introam_calls_outlocal"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 33] = dr2["introam_calls_other"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 34] = dr2["introam_in_calls"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 35] = dr2["introam_out_sms"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");

                            arrParameters[i, 36] = dr2["misc_ben"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                            arrParameters[i, 37] = dr2["misc_terms"].ToString().Trim().Replace("-2", "UNLIMITED").Replace("-1", "").Replace("&amp;", "&").Replace("&amp;", "&").Replace("~", "&quot;");
                    ...
                    mystr = mystr + "<td class=tablecell align=center colspan=2>One Time charge, if any</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center>2</td>";
                    mystr = mystr + "<td class=tablecell align=center colspan=2>Free calls/SMS/data transfer, if any (included in one time charges)</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                    ...
                    /*
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center>3</td>";
                    mystr = mystr + "<td class=tablecell align=center colspan=2>SIM / Account Validity</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                        mystr = mystr + "<td class=tablecell align=center></td>";
                    }
                    ...
                    */
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center>3</td>";
                    mystr = mystr + "<td class=tablecell align=center colspan=2>Tariff Validity (initial /promotional / base)</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center>5(a)</td>";
                    mystr = mystr + "<td class=tablecell align=center colspan=2>Call charges (initial)</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                        if (arrParameters[i, 6].ToString().Trim() == "REGULAR")
                        {
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center>5(b)</td>";
                    mystr = mystr + "<td class=tablecell align=center colspan=2>Call charges (promotional)</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                        if (arrParameters[i, 6].ToString().Trim() == "PROMOTIONAL")
                        {
                            mystr = mystr + "<td class=tablecell align=center>" + arrParameters[i, 9].ToString().Trim() + "</td>";
                        }
                        else
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center rowspan=3>6(a)</td>";
                    mystr = mystr + "<td class=tablecell align=center rowspan=3>Local Call Charges</td>";
                    ...
                    mystr = mystr + "</tr>";
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center>Fixed Line (onnet/offnet)</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center rowspan=3>6(b)</td>";
                    mystr = mystr + "<td class=tablecell align=center rowspan=3>STD Call Charges</td>";
                    mystr = mystr + "<td class=tablecell align=center>Mobile on net</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center>6(c)</td>";
                    mystr = mystr + "<td class=tablecell align=center colspan=2>ISD Call Charges (Mobile)</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center>6(d)</td>";
                    mystr = mystr + "<td class=tablecell align=center colspan=2>ISD Call Charges (Landline)</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center rowspan=3>6(e)</td>";
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center rowspan=3>7</td>";
                    mystr = mystr + "<td class=tablecell align=center rowspan=3>Data Charges</td>";
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center rowspan=3>8(a)</td>";
                    ...
                    */
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center rowspan=4>8(b)</td>";
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center rowspan=4>8(c)</td>";
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center>9</td>";
                    mystr = mystr + "<td class=tablecell align=center colspan=2>Special benefits, if any</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                    ...
                    mystr = mystr + "<tr>";
                    mystr = mystr + "<td class=tablecell align=center>10</td>";
                    mystr = mystr + "<td class=tablecell align=center colspan=2>Recharge /other condition, if any</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                    ...
                    mystr = mystr + "<td class=tablecell align=center colspan=2>Number of subscribers for Quarter ending</td>";
                    for (int i = 0; i < plancount; i++)
                    {
                    ...
                    mystr = mystr + "<td class=tablecell align=center colspan=2>Website link (URL) of the tariff plans</td>";
                    for (int i = 0; i < plancount; i++)
                    {
