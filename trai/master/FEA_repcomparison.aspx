<%@ Page Language="C#" AutoEventWireup="true" EnableViewStateMac="false" ValidateRequest="false" CodeFile="FEA_repcomparison.aspx.cs" Inherits="FEA_repcomparison" %>
                ...
                <table width="100%" cellspacing="1" cellpadding="5">
                    <tr>
                        <td align="center" colspan="4" class="tableheadcenter">
                            <table width="100%">
                                <tr>
                                    <td align="right" class="tablehead" width="50%"><b>Comparison Report : </b></td>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="tablehead" align="right">
                            <asp:CheckBox ID="ChkAllCircles" runat="server" onclick="funChkAll('ChkAllCircles','ChkCirc')" CssClass="input3" Text="Select All" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    </tr>
                    <tr>
                        <td colspan="4" class="tablecell3b" align="center" valign="top">
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="tablehead" align="right">
                            <asp:CheckBox ID="CheckAllTtypes" runat="server" onclick="funChkAll('CheckAllTtypes','ChkTtype')" CssClass="input3" Text="Select All" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    </tr>
                    <tr>
                        <td colspan="4" class="tablecell3b" align="center" valign="top">
                    ...
                    <tr>
                        <td align="center" class="tablehead" valign="top" width="25%">Launch Date Range</td>
                        <td align="center" class="tablehead" valign="top" width="25%">Reporting Date Range</td>
                        <td align="center" class="tablehead" valign="top" width="25%">Price / Rental Range</td>
                        <td align="center" class="tablehead" valign="top" width="25%">Withdrawn Tariffs</td>
                    </tr>
                    <tr>
