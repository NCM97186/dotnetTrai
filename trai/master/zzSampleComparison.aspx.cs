...
public partial class zzSampleComparison : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            */
            ...
            mystr = mystr + "<tr>";
            mystr = mystr + "<td class=tablehead align=center width=3%></td>";
            mystr = mystr + "<td class=tablehead align=center width=8%>TSP</td>";
            ...
            mystr = mystr + "<tr>";
            mystr = mystr + "<td class=tablehead align=center><input type=checkbox></td>";
            mystr = mystr + "<td class=tablecell3 align=center>Airtel</td>";
            mystr = mystr + "<td class=tablecell3 align=center>Andhra Pradesh</td>";
            mystr = mystr + "<td class=tablecell3 align=center>Prepaid STV</td>";
            mystr = mystr + "<td class=tablecell3 align=center>5</td>";
            mystr = mystr + "<td class=tablecell3 align=center>1</td>";
            mystr = mystr + "<td class=tablecell3 align=center>AT02PMST0001</td>";
            ...
            mystr = mystr + "<tr>";
            mystr = mystr + "<td class=tablehead align=center><input type=checkbox></td>";
            mystr = mystr + "<td class=tablecell3b align=center>Idea</td>";
            mystr = mystr + "<td class=tablecell3b align=center>Andhra Pradesh</td>";
            mystr = mystr + "<td class=tablecell3b align=center>Prepaid STV</td>";
            mystr = mystr + "<td class=tablecell3b align=center>6</td>";
            mystr = mystr + "<td class=tablecell3b align=center>1</td>";
            mystr = mystr + "<td class=tablecell3b align=center>AT02PMST0021</td>";
            ...
            mystr = mystr + "<tr>";
            mystr = mystr + "<td class=tablehead align=center><input type=checkbox></td>";
            mystr = mystr + "<td class=tablecell3 align=center>Jio</td>";
            mystr = mystr + "<td class=tablecell3 align=center>Andhra Pradesh</td>";
            mystr = mystr + "<td class=tablecell3 align=center>Prepaid STV</td>";
            mystr = mystr + "<td class=tablecell3 align=center>8</td>";
            mystr = mystr + "<td class=tablecell3 align=center>90</td>";
            mystr = mystr + "<td class=tablecell3 align=center>AT02PMST0013</td>";
            ...
            mystr = mystr + "<tr>";
            mystr = mystr + "<td class=tablehead align=center><input type=checkbox></td>";
            mystr = mystr + "<td class=tablecell3b align=center>MTNL</td>";
            mystr = mystr + "<td class=tablecell3b align=center>Andhra Pradesh</td>";
            mystr = mystr + "<td class=tablecell3b align=center>Prepaid STV</td>";
            mystr = mystr + "<td class=tablecell3b align=center>3</td>";
            mystr = mystr + "<td class=tablecell3b align=center>3</td>";
            mystr = mystr + "<td class=tablecell3b align=center>AT02PMST0023</td>";
            ...
            mystr = mystr + "<tr>";
            mystr = mystr + "<td class=tablehead align=center><input type=checkbox></td>";
            mystr = mystr + "<td class=tablecell3 align=center>Tata Tele</td>";
            mystr = mystr + "<td class=tablecell3 align=center>Andhra Pradesh</td>";
            mystr = mystr + "<td class=tablecell3 align=center>Prepaid STV</td>";
            mystr = mystr + "<td class=tablecell3 align=center>11</td>";
            mystr = mystr + "<td class=tablecell3 align=center>7</td>";
            mystr = mystr + "<td class=tablecell3 align=center>AT02PMST0027</td>";
            mystr = mystr + "<td class=tablecell3 align=left>	Roam Local / STD calls will be charged at Home Local / STD rates ( including benefits of Home STV Rate cutter / Unlimited packs/Bulk Minute /SMS pack)</td>";
            mystr = mystr + "<td class=tablecell3 align=center><img src=images/lensplus.png border=0></td>";
            mystr = mystr + "</tr>";

            mystr = mystr + "<tr>";
            mystr = mystr + "<td class=tablehead align=center><input type=checkbox></td>";
            mystr = mystr + "<td class=tablecell3b align=center>Vodafone</td>";
            mystr = mystr + "<td class=tablecell3b align=center>Andhra Pradesh</td>";
            mystr = mystr + "<td class=tablecell3b align=center>Prepaid STV</td>";
            mystr = mystr + "<td class=tablecell3b align=center>7</td>";
            mystr = mystr + "<td class=tablecell3b align=center>1</td>";
            mystr = mystr + "<td class=tablecell3b align=center>AT02PMST0031</td>";
            mystr = mystr + "<td class=tablecell3b align=left>	Roam Local / STD calls will be charged at Home Local / STD rates ( including benefits of Home STV Rate cutter / Unlimited packs/Bulk Minute /SMS pack)</td>";
            mystr = mystr + "<td class=tablecell3b align=center><img src=images/lensplus.png border=0></td>";
            mystr = mystr + "</tr>";
