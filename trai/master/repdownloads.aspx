<%@ Page Language="C#" AutoEventWireup="true" EnableViewStateMac="false" ValidateRequest="false" CodeFile="repdownloads.aspx.cs" Inherits="repdownloads" %>
...
<body>
    ...
    <center><br />
        ...
        <table width="90%" id="tbLedger" runat="server" cellspacing="1" cellpadding="7">
            <tr>
                <td class="tablehead" align="center" colspan="2">Consumer View Downloads</td>
            </tr>
            <tr>
