...
public partial class TSP_changepass : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            com = new MySqlCommand("update TRAI_TSPUsers set pass='" + TextBox1.Text.Trim() + "' where(uname='" + Request["user"].ToString().Trim() + "')", con);
            con.Open();
            com.ExecuteNonQuery();
            con.Close();
