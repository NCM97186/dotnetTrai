<%@ Page Language="C#" AutoEventWireup="true" EnableViewStateMac="false" ValidateRequest="false" CodeFile="mastercircles.aspx.cs" Inherits="mastercircles" %>
...
<body>
    ...
    <center><p align="right"><asp:TextBox ID="TextDelNo" runat="server" width="1" Height="1" CssClass="input1"></asp:TextBox></p>
            <table width="70%" cellspacing="1" cellpadding="14">
                <tr>
                    <td align="center" colspan="2" class="tablehead" valign="top">LSA Management</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="left" valign="top" class="tablecell3">LSA Code <font color="red"><b>*</b></font></td>
                    <td align="left" valign="top" class="tablecell3"><asp:TextBox ID="TextBox2" runat="server" Width="25" MaxLength="2" CssClass="input"></asp:TextBox></td>
                </tr>
