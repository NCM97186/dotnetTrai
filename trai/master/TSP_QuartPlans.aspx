<%@ Page Language="C#" AutoEventWireup="true" EnableViewStateMac="false" ValidateRequest="false"  CodeFile="TSP_QuartPlans.aspx.cs" Inherits="TSP_QuartPlans" %>
...
<center >
    ...
    <div>
        ...
        <table width="95%" runat="server" cellspacing="1" cellpadding="8">
            <tr>
            <td colspan="2" align="center" class="tablehead">Existing Tariff Plans - Not On Offer</td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" align="center" class="tablecell3">
                    <asp:Button ID="Button1" runat="server" Width="100px" CssClass="input" OnClientClick="ShowProcessMessage('ProcessingWindow')" OnClick="Button1_Click" Text="Next" />
                </td>
            </tr>
        </table>
        <table width="95%" runat="server" cellspacing="1" cellpadding="8" id="Table1" visible="false">
            <tr>
                <td align="center" class="tablehead" id="TdData" runat="server" visible="false"></td>
            </tr>
            <tr>
                <td align="center" class="tablehead" id="TdSubmit" runat="server">
                    <asp:Button ID="Button2" runat="server" Width="100px" CssClass="input" OnClientClick="hideButton2();" OnClick="Button2_Click"  Text="Submit" />
                </td>
            </tr>
        ...
        <br /><br /><br />
        <div id="divresults" style="width:95%;" runat="server"></div>
