<%@ Page Language="C#" AutoEventWireup="true" EnableViewStateMac="false" ValidateRequest="false"  CodeFile="FEA_frame.aspx.cs" Inherits="FEA_frame" %>
...
<frame name ="Leftframe" id="Leftframe" src="FEA_Common.aspx?user=<%=Session["master"].ToString().Trim() %>"></frame>
