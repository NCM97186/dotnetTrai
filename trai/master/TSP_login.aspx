<%@ Page Language="C#" AutoEventWireup="true" EnableViewStateMac="false" ValidateRequest="false"  CodeFile="TSP_login.aspx.cs" Inherits="TSP_login" %>
...
<center>
    ...
    <table width="350px" cellspacing="1" cellpadding="7" border="1" style="border-collapse:collapse;">
        <tr>
            <td colspan="2" align="center" class="tableheadcenter"><b>TSP / ISP Login</b></td>
        </tr>
        <tr>
 ...
 <tr>
                        <asp:UpdatePanel ID="UP1" runat="server">
                            ...
                            <ContentTemplate>
                                <td class="tablecell2b" width="100%">
                                    ...
                                    <label for="txtCaptcha">
                                        <span style="color: red">Note: Please enter the code shown above.</span>
                                    </label>
                                </td>
                                <td class="tablecell2b">
    ...
    <div style="text-align:left; width:1000px; font-family:Arial, Verdana; font-size:13px;">
        <asp:CheckBox ID="Check1" runat="server" Text="Certified that the tariff plan(s)/are consistent with the regulatory principles in all respects which inter–alia include transparency, non-discrimination and non-predation." />
        <br /><br />
        <asp:CheckBox ID="Check2" runat="server" Text="Certified that the tariff plans are posted on the website and displayed at outlets in accordance with TRAI’s Direction dated 3rd April 2019." />
    </div>
        </div>
    ...
    <a href="TSP_forgot.aspx" runat="server" class="indexlinks1"><u>Forgot Password? Click Here</u></a>
