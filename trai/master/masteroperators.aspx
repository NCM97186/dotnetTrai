<%@ Page Language="C#" AutoEventWireup="true" EnableViewStateMac="false" ValidateRequest="false" CodeFile="masteroperators.aspx.cs" Inherits="masteroperators" %>
...
<body>
    ...
    <center><p align="right"><asp:TextBox ID="TextDelNo" runat="server" width="1" Height="1" CssClass="input1"></asp:TextBox></p>
            <table width="70%" cellspacing="1" cellpadding="14">
                <tr>
                    <td align="center" colspan="2" class="tablehead" valign="top">TSP / ISP Management</td>
                </tr>
                <tr>
                    <td width="50%" align="left" valign="top" class="tablecell3">TSP / ISP <font color="red"><b>*</b></font></td>
                    <td align="left" valign="top" class="tablecell3"><asp:TextBox ID="TextBox1" runat="server" Width="200" CssClass="input"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="left" valign="top" class="tablecell3">TSP / ISP Code <font color="red"><b>*</b></font></td>
                    <td align="left" valign="top" class="tablecell3"><asp:TextBox ID="TextBox2" runat="server" Width="20" MaxLength="2" CssClass="input"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="left" valign="top" class="tablecell3">TSP / ISP Company Name <font color="red"><b>*</b></font></td>
                    <td align="left" valign="top" class="tablecell3"><asp:TextBox ID="TextBox3" runat="server" Width="300" CssClass="input"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="left" valign="top" class="tablecell3">TSP / ISP Company Address <font color="red"><b>*</b></font></td>
                    <td align="left" valign="top" class="tablecell3"><asp:TextBox ID="TextBox4" runat="server" Width="300" Height="50" TextMode="Multiline" CssClass="input"></asp:TextBox></td>
                </tr>
               <tr>
