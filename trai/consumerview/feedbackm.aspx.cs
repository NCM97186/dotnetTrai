...
public partial class feedbackm : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (flag == 0)
            {
                ...
                else
                {
                    ...
                    com = new MySqlCommand("insert into " + tablename + " values('" + zno + "','" + pname + "','" + mobile + "','" + feedback + "','" + DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss") + "','Mobile')", con);
                    con.Open();
                    com.ExecuteNonQuery();
                    con.Clone();
